...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fsrc%2Fmiddleware.ts&page=%2Fsrc%2Fmiddleware&rootDir=C%3A%5CUsers%5Cdngvieth_23%5COneDrive%5CDesktop%5Clocal-shop&matchers=W3sicmVnZXhwIjoiXig%2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpP1xcL2FkbWluKD86XFwvKCg%2FOlteXFwvI1xcP10rPykoPzpcXC8oPzpbXlxcLyNcXD9dKz8pKSopKT8oLmpzb24pP1tcXC8jXFw%2FXT8kIiwib3JpZ2luYWxTb3VyY2UiOiIvYWRtaW4vOnBhdGgqIn1d&preferredRegion=&middlewareConfig=eyJtYXRjaGVycyI6W3sicmVnZXhwIjoiXig%2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpP1xcL2FkbWluKD86XFwvKCg%2FOlteXFwvI1xcP10rPykoPzpcXC8oPzpbXlxcLyNcXD9dKz8pKSopKT8oLmpzb24pP1tcXC8jXFw%2FXT8kIiwib3JpZ2luYWxTb3VyY2UiOiIvYWRtaW4vOnBhdGgqIn1dfQ%3D%3D!
...
var supabase;
function createClientComponentClient({ supabaseUrl = "https://sbfwbfmieertcddmylgy.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNiZndiZm1pZWVydGNkZG15bGd5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDI1MzUwNDksImV4cCI6MjA1ODExMTA0OX0.4vmtu-ruAej9bAeUbcrbcVi6P9KRNtBo6fZJ_7M8JCw", options, cookieOptions, isSingleton = true } = {}) {
...
function createPagesServerClient(context, { supabaseUrl = "https://sbfwbfmieertcddmylgy.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNiZndiZm1pZWVydGNkZG15bGd5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDI1MzUwNDksImV4cCI6MjA1ODExMTA0OX0.4vmtu-ruAej9bAeUbcrbcVi6P9KRNtBo6fZJ_7M8JCw", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
function createMiddlewareClient(context, { supabaseUrl = "https://sbfwbfmieertcddmylgy.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNiZndiZm1pZWVydGNkZG15bGd5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDI1MzUwNDksImV4cCI6MjA1ODExMTA0OX0.4vmtu-ruAej9bAeUbcrbcVi6P9KRNtBo6fZJ_7M8JCw", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
function createServerComponentClient(context, { supabaseUrl = "https://sbfwbfmieertcddmylgy.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNiZndiZm1pZWVydGNkZG15bGd5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDI1MzUwNDksImV4cCI6MjA1ODExMTA0OX0.4vmtu-ruAej9bAeUbcrbcVi6P9KRNtBo6fZJ_7M8JCw", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
function createRouteHandlerClient(context, { supabaseUrl = "https://sbfwbfmieertcddmylgy.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNiZndiZm1pZWVydGNkZG15bGd5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDI1MzUwNDksImV4cCI6MjA1ODExMTA0OX0.4vmtu-ruAej9bAeUbcrbcVi6P9KRNtBo6fZJ_7M8JCw", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
// src/deprecated.ts
function createBrowserSupabaseClient({ supabaseUrl = "https://sbfwbfmieertcddmylgy.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNiZndiZm1pZWVydGNkZG15bGd5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDI1MzUwNDksImV4cCI6MjA1ODExMTA0OX0.4vmtu-ruAej9bAeUbcrbcVi6P9KRNtBo6fZJ_7M8JCw", options, cookieOptions } = {}) {
...
function createServerSupabaseClient(context, { supabaseUrl = "https://sbfwbfmieertcddmylgy.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNiZndiZm1pZWVydGNkZG15bGd5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDI1MzUwNDksImV4cCI6MjA1ODExMTA0OX0.4vmtu-ruAej9bAeUbcrbcVi6P9KRNtBo6fZJ_7M8JCw", options, cookieOptions } = {}) {
...
function createMiddlewareSupabaseClient(context, { supabaseUrl = "https://sbfwbfmieertcddmylgy.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNiZndiZm1pZWVydGNkZG15bGd5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDI1MzUwNDksImV4cCI6MjA1ODExMTA0OX0.4vmtu-ruAej9bAeUbcrbcVi6P9KRNtBo6fZJ_7M8JCw", options, cookieOptions } = {}) {
